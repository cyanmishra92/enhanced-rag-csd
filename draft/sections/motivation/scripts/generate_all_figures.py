...
def main():
    ...
    os.chdir(script_dir.parent.parent.parent.parent)
    
    # List of analysis scripts to run
    analysis_scripts = [
        ("draft/sections/motivation/scripts/gpu_memory_analysis.py", "GPU Memory Swapping Analysis"),
        ("draft/sections/motivation/scripts/data_movement_analysis.py", "Data Movement and Bandwidth Analysis"),
        ("draft/sections/motivation/scripts/computational_comparison.py", "Computational Capability Comparison"),
        ("draft/sections/motivation/scripts/csd_capabilities_analysis.py", "Modern CSD Capabilities Analysis"),
        ("draft/sections/motivation/scripts/index_rebuilding_analysis.py", "Index Rebuilding Cost Analysis")
    ]
    ...
    figures_dir = Path("draft/sections/motivation/figures")
    tables_dir = Path("draft/sections/motivation/tables")
    if figures_dir.exists():
        pdf_files = list(figures_dir.glob("*.pdf"))
        csv_files = list(tables_dir.glob("*.csv")) if tables_dir.exists() else []
